...
export default function AppPayment() {
  ...
  const handleClick = async () => {
    const result = await fetch("/api/payment/addTokens", {
      method: "POST",
    });
  ...
  return (
    <>
      <div className="flex sm:flex-row flex-col sm:items-center text-lg font-semibold mt-8 mb-4">
        <span className="rounded-full bg-gray-700 text-white text-xs px-2 mr-auto sm:mr-2 mb-2 sm:mb-0">
          Step 1
        </span>
        Premium
      </div>
      {/* <form id="pu-form" method="post"> */}
      <input
        type="hidden"
        name="_token"
        value="N5CAqBbI6KBpLYlgyIAInEhlDb1bvcZt99fkQf1w"
      />
      ...
      <div className="flex flex-wrap lg:flex-no-wrap">
        ...
        <label
          htmlFor="y-99"
          className="relative premium-plan-radio-box flex flex-col justify-center h-32 items-center cursor-pointer w-64 sm:w-48 bg-white border-[#ef5753] border-2 hover:shadow mb-4 mr-4"
        >
          <span className="absolute rounded-full top-0 left-0 ml-1 mt-1 w-6 h-6 border-2 border-[#ef5753]">
            <svg
              viewBox="0 0 1792 1792"
              xmlns="http://www.w3.org/2000/svg"
              className="inline-block text-green-400 fill-[#ef5753] absolute visible w-4 h-4 text-brand top-[2px] left-[2px]"
            >
              <path d="M1671 566q0 40-28 68l-724 724-136 136q-28 28-68 28t-68-28l-136-136-362-362q-28-28-28-68t28-68l136-136q28-28 68-28t68 28l294 295 656-657q28-28 68-28t68 28l136 136q28 28 28 68z"></path>
            </svg>
          </span>
          <span className="text-xl md:text-2xl font-semibold">Lifetime</span>
          <span className="paddle-gross text-xl" data-product="831006">
            US$49.00
          </span>
          <span className="flex items-center text-xs text-gray-600 mt-2 -mb-2 lg:-mb-4">
            One-time payment
          </span>
        </label>
      </div>
        ...
        <label className="block font-semibold cursor-pointer">
          {/* <span className="text-sm">Your email address</span>
            <input
              ...
              required=""
            /> */}
          You have already created an account, and you are logged in.
        </label>

        <div className="text-right text-sm mt-2">
          <a
            id="existing-account-btn"
      ...
      <div className="mt-8 mb-16">
        <button
          className="inline-flex items-center rounded text-white p-2 text-2xl py-3 px-5 font-semibold bg-[#ef5753] hover:bg-red-600"
          dusk="continue"
          onClick={handleClick}
        >
          Continue
      ...
      <div className="flex space-x-8 mb-4">
        <div className="mb-4">
          <ul className="sm:flex space-x-1" role="list">
            <div className="flex space-x-1">
              ...
              <li className="list-payment__item"></li>
              <li className="list-payment__item">
                <svg
                  className="icon icon--full-color"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex space-x-1 sm:mt-0 mt-2">
              <li className="list-payment__item">
                <svg
                  className="icon icon--full-color"
                  viewBox="0 0 38 24"
      ...
      <div className="mb-12">
        <div className="flex items-center text-sm">
          <svg
            className="fill-current text-green-400 w-5 h-5 mr-2"
            viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
          ...
          <div>30-day 100% money-back guarantee, no questions asked</div>
        </div>
        ...
        <div className="flex items-center text-sm my-4">
          ...
          <div>
            One-time payment, you {"won't"} be billed again automatically
          </div>
        </div>
        ...
        <div className="flex items-center text-sm">
          ...
          <span>
            Payments are securely handled by{" "}
            <a
